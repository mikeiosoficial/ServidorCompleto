        function showSuccessAlert() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '/add-days'; // Redireciona para a rota /remove (ou outra rota apropriada)
                }
            });
        }
        ...
        function showNonexistentLoginAlert() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '/add-days'; // Redireciona para a rota /login (ou outra rota apropriada)
                }
            });
        }
