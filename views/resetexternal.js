       function showSuccessAlert() {
            Swal.fire({
                icon: 'success',
                title: 'Sucesso',
                text: 'Usuário resetado'
            }).then((result) => {
                if (result.isConfirmed) {
                    window.location.href = '/resetexternal'; // Redireciona para a rota /remove (ou outra rota apropriada)
                }
            });
        }
        ...
        function showNonexistentLoginAlert() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '/resetexternal'; // Redireciona para a rota /login (ou outra rota apropriada)
                }
            });
        }
        ...
        function showErrorResetAlert() {
            Swal.fire({
                ...
                text: 'Não é possível resetar logins de outros vendedores'
            }).then((result) => {
                if (result.isConfirmed) {
                    window.location.href = '/resetexternal'; // Redireciona para a rota /remove (ou outra rota apropriada)
                }
